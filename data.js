...
const CFG = {
  ...
  kpi: {
    ...
    c15AnnualPct : 47.0,    // % vs KH năm (dùng T6 lũy kế)
    c15T6Actual  : 18737,   // Lũy kế T6 (W1+W2, chưa đủ tháng)
    c15T6Change  : -967,    // Thay đổi T6 W1+W2
    ...
    // REG (delta từ base 297.941 tháng 12/2025)
    regYtdActual : 22039,   // Lũy kế tăng ròng đến T6 (14/06): REG_N(T6)−base
    regYtdPlan   : 21000,   // Lũy kế KH T6 = 6 × 3.500
    regYtdPct    : 104.9,
  },
  ...
  c15: {
    actual  : [3820,  1422, 10584,  -689, 4567,  -967],
    plan    : [3259, -2385,  9275,  1172, 6988,  1731],
    ytd     : [3820,  5242, 15826, 15137, 19704, 18737],
  ...
  // Nguồn: file Reg 1506 site.xlsx — dòng 4 (Totals), cột REG_N
  // Base (T0, 31/12/2025): 297.941
  // growth  = REG_N(T) − REG_N(T−1)  : tăng trưởng ròng tháng
  // ytd     = REG_N(T) − base         : lũy kế tăng từ đầu năm
  // absActual = REG_N tuyệt đối (dùng để tham chiếu)
  // ytdPlan = N × 3.500               : KH lũy kế
  reg: {
    base      : 297941,
    growth    : [4560, 6948, 3295, 3614, 1105, 2517],
    ytd       : [4560, 11508, 14803, 18417, 19522, 22039],
    absActual : [302501, 309449, 312744, 316358, 317463, 319980],
    absPlan   : [301441, 304941, 308441, 311941, 315441, 318941],
  ...
  rev: {
    actual : [6274.2, 6217.2, 6546.8, 6497.1, 6611.5, 4166.4],
    plan   : [6194.8, 6177.9, 6281.5, 6398.2, 6489.3, 6586.7],
    // T6 có W1+W2 (01–15/06), chưa đầy đủ tháng
  },
